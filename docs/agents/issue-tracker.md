...
- Project number: `27`
- Project title: `Quote Switcher`
- Project URL: https://github.com/users/gvastethecreator/projects/27
- Local root: `.scratch/vscode-quote-switcher/`
...
- Spec: `.scratch/vscode-quote-switcher/spec.md` (`PRD.md` remains compatible).
- Ticket mirrors: `.scratch/vscode-quote-switcher/issues/<NN>-<slug>.md`. Never under `docs/`.
- Rejected requests: `.scratch/vscode-quote-switcher/out-of-scope/<concept>.md`.
...
GitHub project: https://github.com/users/gvastethecreator/projects/27
...
5. Add the Issue to Project `27` under `gvastethecreator`.
...
```powershell
gh issue view <number> -R gvastethecreator/vscode-quote-switcher --json number,title,state,body,labels,assignees,comments,updatedAt,url
gh project view 27 --owner gvastethecreator --format json
gh project field-list 27 --owner gvastethecreator --format json
gh project item-list 27 --owner gvastethecreator --limit 200 --format json --field Status
gh project item-add 27 --owner gvastethecreator --url <issue-url>
gh project item-edit 27 --owner gvastethecreator --url <issue-url> --field Status --value Todo
gh issue create -R gvastethecreator/vscode-quote-switcher --title <title> --body-file <path> --parent <parent-number> --blocked-by <number,number>
gh issue edit <issue-number> -R gvastethecreator/vscode-quote-switcher --parent <parent-number> --add-blocked-by <number>
```
