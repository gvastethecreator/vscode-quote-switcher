...
VS Code extension (`gvastethecreator.quote-switcher`). pnpm. TypeScript in `src/`. esbuild writes `dist/extension.js`.
...
- Do not write tickets under `docs/`. Local tickets: `.scratch/vscode-quote-switcher/issues/`.
